  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <p className='text-[#8892b0] py-4 max-w-[700px]'>I'm a full-stack developer specializing in creating unique and fun digital experiences. I have a passion for creating exceptional web apps that are both mobile responsive and user-friendly. Currently, I'm enjoying working front-end with React.js and Tailwind. I love to go fishing and enjoy outdoor activities.</p>
        <div>
